...
<br>
	...
	<form method="post" action="welcome_i.jsp?course_id=${ctx.courseId.externalString}"> 
		<input type="submit" name="button" id="ActivateLab3" value="Activate Lab 3"  />
	</form>
<br>	
...
<br>
    	<input type="submit" name="button" id="ActivateLab7" value="Activate" onclick="ActivateLab7()"  />
    	<input type="submit" name="button" id="Lab7" value="lab 7" disabled onclick="callLab7()"/>
		
<br>
		<input type="submit" name="button" id="ActivateLab8" value="Activate" onclick="ActivateLab8()" />
		<input type="submit" name="button" id="Lab8" value="lab 8" disabled onclick="callLab8()"/>		
<br>
		<input type="submit" name="button" id="ActivateLab9" value="Activate" onclick="ActivateLab9()" />
