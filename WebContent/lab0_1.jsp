            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <th>
                            <input type="number" name="00" <% if (checks.getData(0,0) != null){out.print("value=\"" + checks.getData(0,0) + "\"");}%> />
                        </th>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        ...
                        <th>
                            <input type="number" name="10" <% if (checks.getData(1,0) != null){out.print("value=\"" + checks.getData(1,0) + "\"");}%> />
                        </th>
                    </tr>
                    <tr>
                        <th>
